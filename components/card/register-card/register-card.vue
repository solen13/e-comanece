<template>
    <form class="register-card" @submit.prevent="submitForm">
      ...
      <div class="grid grid-cols-2 gap-20 mt-10">
        <div>
          ...
          <div class="grid grid-cols-2 gap-4 mt-5">
            <span>
              <label>Adınız</label>
              <input v-model="username" name="username" type="text" class="input-style" placeholder="Adınız" />
              <ErrorMessage name="username" />
            </span>
            <span>
              <label>Soyadınız</label>
              <input v-model="surname"  name="surname" type="text" class="input-style" placeholder="Soyadınız" />
            ...
            <span>
              ...
              <input v-model="password" name="password" type="text" class="input-style" placeholder="Parolanız" />
              <ErrorMessage name="password" />
            </span>
  
            <span>
              <label>Parolanız (Tekrar) {{password===passwordConfirmation}}</label>
              <input v-model="passwordConfirmation" name="passwordConfirmation" type="text" class="input-style" placeholder="Parolanız (Tekrar)" data-vv-as="password" />
        ...
        <div class="flex flex-col justify-between">
          <span>
            ...
            <input v-model="addressTitle" name="addressTitle" type="text" class="input-style" placeholder="Adres Başlığı" />
            <ErrorMessage name="addressTitle" />
  
          </span>
          <span>
            <label>İl</label>
            <input v-model="city" name="city" type="text" class="input-style" placeholder="İl" />
              <ErrorMessage name="city" />
          </span>
          <span>
            <label>İlçe</label>
            <input v-model="district" nam="district" type="text" class="input-style" placeholder="İlçe" />
            <ErrorMessage name="district" />
  
          </span>
          <span>
            <label>Adres</label>
            <input v-model="fullAddress" name="fullAddress" type="text" class="input-style" placeholder="Adres" />
      ...
      <div class="mt-7">
        <button type="submit" class="w-full bg-darkGreen text-white-100 py-2 rounded-lg">
          Kayıt Ol
        </button>
  ...
  <script setup>
  import { useForm, useField, useIsFieldValid,useIsFieldTouched } from "vee-validate";
